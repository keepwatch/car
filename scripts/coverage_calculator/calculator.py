...
def download_library(library_name, repo_url, root_path):
    ...
    library_zip = os.path.join(root_path, f"{library_name}.zip")
...
for library in DETECTION_LIBRARIES:
    ...
    skipped[library] = {}
    search_path = os.path.join(ROOT_SEARCH_PATH,DETECTION_LIBRARIES[library]["search_path"])
